...
//fılter ıf ın yaptıgı ı yapıyor
    }
    ...
    public static void printCiftElFunctional1(List<Integer> sayi) {
        ...
        sayi.stream().//list elemanlrı akısa alındı
                filter(Lambda01::ciftBul).//cift bul method refere edilerek akısdaki elemanlar filtrelendi(cift sayı)
                forEach(Lambda01::yazdir);//filtre den gelen elemanlar yazdır() method refer edilerek print edildi
    ...
    public static void printCiftOtzKckFunctional(List<Integer> sayi) {
        sayi.
                ...
                filter(t -> t <34).//lambda expressıon
